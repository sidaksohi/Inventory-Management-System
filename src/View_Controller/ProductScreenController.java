...
public class ProductScreenController implements Initializable {
    ...
    public ProductScreenController(Inventory inv){
        this.inv = inv;
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        idField.setText(String.valueOf(inv.getAllProducts().size()+ 1));
    ...
    private void generatea_PartsTable(){
    ...
    private void saveProduct(MouseEvent event) throws IOException{   
        ...
        inv.addProduct(new Product (Integer.valueOf(idField.getText()), nameField.getText(), Double.valueOf(priceField.getText()), Integer.valueOf(invField.getText()),
    ...
    private void cancelProduct(MouseEvent event) throws IOException{     
        cancelProductConfirmation("","Cancel adding product?", event);
    }
